...
class CubicSplineInterpolation():
    """Реализация интерполяции с помощью кубического сплайна."""
    ...
    def __init__(self, argument_x: float, list_points: list, boundary_conditions: tuple):
        ...
        # Списки координат x и y массива входных точек.
        self.list_x = list()
        self.list_y = list()

        # Списки для компонентов 3-х диагональной матрицы.
        self.list_A_components = list()
        self.list_B_components = list()
        self.list_D_components = list()
        self.list_F_components = list()  # Правильнее будет сказать, что F - столбец свободных членов.

        # Списки для вспомогательных переменных.
        self.list_h_variables = list()
        self.list_ksi_variables = list()
        self.list_eta_variables = list()

        # Списки для искомых коэффициентов.
    ...
    def interpolate(self):
        """Производит интерполяцию кубическими сплайнами."""
        self._listXFill()
        self._listYFill()
    ...
    def _yValue(self):
        """Вычисляет значение y(x) для заданного аргумента x."""
    ...
    def _listXFill(self):
        """Заполняет список координат x всех входных точек."""
        for i in range(len(self.list_points)):
            self.list_x.append(self.list_points[i][0])

    def _listYFill(self):
        """Заполняет список координат y всех входных точек."""
        for i in range(len(self.list_points)):
    ...
    def _listAComponentsFill(self):
        """Заполняет список компонентов A 3-х диагональной матрицы."""
    ...
    def _listBComponentsFill(self):
        """Заполняет список компонентов B 3-х диагональной матрицы."""
    ...
    def _listDComponentsFill(self):
        """Заполняет список компонентов D 3-х диагональной матрицы."""
    ...
    def _listFComponentsFill(self):
        """Заполняет список свободных членов F 3-х диагональной матрицы."""
    ...
    def _listKsiVariablesFill(self):
        """Заполняет список прогоночных переменных 'кси'."""
    ...
    def _listEtaVariablesFill(self):
        """Заполняет список прогоночных переменных 'эта'."""
    ...
    def _listACoefficientsFill(self):
        """Заполняет список для неизвестных a коэффициентов."""
    ...
    def _listCCoefficientsFill(self):
        """Заполняет список для неизвестных c коэффициентов."""
    ...
    def _listBCoefficientsFill(self):
        """Заполняет список для неизвестных b коэффициентов."""
    ...
    def _listDCoefficientsFill(self):
        """Заполняет список для неизвестных d коэффициентов."""
